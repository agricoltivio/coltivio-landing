...
const translations: Record<Locale, Translations> = {
  de: {
    ...
    hero: {
      ...
      sub: 'Die mobile-first, quelloffene Hofverwaltung für Schweizer Familienbetriebe. Felder, Tiere und Direktvermarktung in einer App. Keine Investoren, keine Agrarindustrie, deine Daten gehören dir. Auf Deutsch, Französisch, Italienisch und Englisch.',
    ...
    membership: {
      ...
      cta: 'Mitglied werden',
      price: 'Eine Mitgliedschaft kostet CHF 75 pro Jahr und gibt dir Zugang zu allen Funktionen.',
    },
  ...
  fr: {
    ...
    hero: {
      ...
      sub: "La gestion agricole mobile-first et open source pour les exploitations familiales suisses. Champs, animaux et vente directe dans une seule app. Pas d'investisseurs, pas d'agro-industrie, tes données t'appartiennent. En allemand, français, italien et anglais.",
    ...
    membership: {
      ...
      cta: 'Devenir membre',
      price: "Une adhésion coûte CHF 75 par an et donne accès à toutes les fonctionnalités.",
    },
  ...
  it: {
    ...
    hero: {
      ...
      sub: "La gestione agricola mobile-first e open source per le aziende familiari svizzere. Campi, animali e vendita diretta in un'unica app. Nessun investitore, nessuna industria agroalimentare, i tuoi dati sono tuoi. In tedesco, francese, italiano e inglese.",
    ...
    membership: {
      ...
      cta: 'Diventa membro',
      price: "Un'iscrizione costa CHF 75 all'anno e dà accesso a tutte le funzionalità.",
    },
  ...
  en: {
    ...
    hero: {
      ...
      sub: 'The mobile-first, open-source farm manager for Swiss family farms. Fields, animals and direct sales in one app. No investors, no agribusiness, your data belongs to you. In German, French, Italian and English.',
    ...
    membership: {
      ...
      cta: 'Become a member',
      price: 'A membership costs CHF 75 per year and gives you access to all features.',
    },
